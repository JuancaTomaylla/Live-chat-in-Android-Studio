...
public class MensajeriaAdapter extends RecyclerView.Adapter<MensajeriaAdapter.MensajesViewHolder> {
    ...
    @Override                              //Definimos como se mostraran los mensajes, siendo diferente para el EMISOR y RECEPTOR
    ...
    static class MensajesViewHolder extends RecyclerView.ViewHolder{    //Definimos los apartados que tendra nuestro Mensaje
